...
public class InventorySystem {
   ...
   * 
   * @param first3 digits of the barcode
   * @param lastDigits of the barcode
   * @return 
   */
  ...
  /**
   * method displays the Barcode, name, manufacturer, type and price of the product
   * 
   * @param returnedProduct object of class Product with specification given by the user
   */
